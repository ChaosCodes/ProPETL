    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            optimizer_grouped_parameters = [
                {
                    "params": [p for n, p in self.model.named_parameters() if n in decay_parameters and mask_parameters in n],
                    "weight_decay": self.args.weight_decay,
                    'lr': self.args.mask_learning_rate,
                },
                {
                    "params": [p for n, p in self.model.named_parameters() if n in decay_parameters and mask_parameters not in n],
                    "weight_decay": self.args.weight_decay,
                },
                {
