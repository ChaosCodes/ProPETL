...
do
  ...
  do
    ...
    # exp_name=share_and_mask.sd_${seed}.arf_${adapter_reduction_factor}.spsty_${sparsity}.mask_lr_${mask_lr}
    # exp_name=share_and_mask.sd_${seed}.prefix_length_${prefix_length}.spsty_${sparsity}
    extra_cmd="--share_adapter"

    # not share
    # exp_name=original.sd_${seed}.prefix_length_${prefix_length}
    ...
    SAVE=/root/autodl-tmp/checkpoints/${TASK_NAME}/prolora/${exp_name}/
    SAVE_FILE=/root/autodl-tmp/checkpoints/${TASK_NAME}/prolora/${exp_name}/test_results.json
