...
class T5LayerFF(T5FFLayerAdaptersMixin, nn.Module):
    ...
    def forward(self, hidden_states, task=None):
        ...
        hidden_states = self.adapter_layer_forward(hidden_states, self.dropout(forwarded_states), None, task=task)
        return hidden_states
...
class T5LayerSelfAttention(T5SelfAttentionLayerAdaptersMixin, nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.adapter_layer_forward(hidden_states, self.dropout(attention_output[0]), None, task=task)
...
class T5LayerCrossAttention(T5CrossAttentionLayerAdaptersMixin, nn.Module):
    ...
    def forward(
        ...
        layer_output = self.adapter_layer_forward(hidden_states, self.dropout(attention_output[0]), None, task=task)
